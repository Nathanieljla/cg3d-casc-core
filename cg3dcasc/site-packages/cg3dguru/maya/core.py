...
def _export():
    ...
    def _create_new_set(scene):
        ...
        maya_id = uuid.uuid1()
        new_object = _create_data(scene, set_name, maya_id, current_roots)
    ...
    for export_set in export_sets:
        ...
        roots = root_beh.behaviours.get()
        
        

    #root_nodes = []
    #for export_set in export_sets:
        #root_nodes.extend(export_set.behaviours.get())
        
    ##if we don't have any roots, then we'll just export the whole scene
    #if root_nodes:
