...
class Property(PyGuid):
    ...
    def __init__(self, name, behaviour): #*args, **kwargs):
        super(Property, self).__init__(None, behaviour)
...
class ObjectProperty(Property):
    ...
    def get(self) -> PyObject |  None:
        ...
        if object_id is None:
            ...
            return PyObject(object_id, self.scene) #self.__get(content)
...
class ReferenceProperty(Property):
    ...
    def set(self, value: PyBehaviour|None):
        if value is None:
            value = csc.Guid.null() #PyObject(csc.model.ObjectId.null(), self.scene)
            
        self.behaviour.set_reference(self.name, value)

        #def _set():
            #self.beh_editor.set_behaviour_reference(self.behaviour, self.name, value)
...
class PropertyRange(Property):
    ...
    #def __init__(self, *args, **kwargs):
        #super(PropertyRange, self).__init__( *args, **kwargs)
